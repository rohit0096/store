...
public class OrderServiceImpl implements IOrderService{
	...
	@Override
	public Optional<Order> getOrderDetailsById(int u_id) {
		// TODO Auto-generated method stub
	...
	public String OrderCancelation(int O_id, int u_id) {
		...
		deliveryDao.deleteAll(deliveryDao.getDeliveryInfobyOrderId(order.getOrderId()));
	...
	public String getDeliverInfoByOrder(Order o) {
		...
		Product p= o.getProduct();
		 DeliveryInfo d= new DeliveryInfo(o.getOrderId(), p.getProductName(), o.getCustomer().getFirstName()+" "+o.getCustomer().getLastName(), o.getOdate().plusDays(7), o.getStatus(), a);
	      deliveryDao.save(d);
