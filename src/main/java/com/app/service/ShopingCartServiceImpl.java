...
public class ShopingCartServiceImpl implements IShopingCartService{
	...
	public CheckOutResponse checkOutProduct(int u_id) {
		...
		for(ShopingCart i : ls) {
			...
			return new CheckOutResponse(u.getFirstName()+" "+u.getLastName(), i.getProduct().getP_Id(), i.getProduct().getProductName(), "Out of Stock");
				}
	...
	public CheckOutResponse availablity(ShopingCart cart,int uId) {
		...
		return new CheckOutResponse(u.getFirstName()+" "+u.getLastName(), cart.getProduct().getP_Id(), cart.getProduct().getProductName(), "Out of Stock");
	}
